...
public class MFreeMuscleElementDesc
   ...
   public static PropertyList myProps =
      new PropertyList (MFreeMuscleElementDesc.class, RenderableComponentBase.class);
   ...
   void setExcitationColors (RenderProps props) {
      ...
      if (gparent instanceof MFreeMuscleBundle) {
         MFreeMuscleBundle bundle = (MFreeMuscleBundle)gparent;
   ...
   private MuscleMaterial getEffectiveMuscleMaterial () {
      if (myMuscleMat != null) {
         ...
         ModelComponent gparent = getGrandParent();
         if (gparent instanceof MFreeMuscleBundle) {
            return ((MFreeMuscleBundle)gparent).getEffectiveMuscleMaterial();
         }
      }
      return null;      
   }
