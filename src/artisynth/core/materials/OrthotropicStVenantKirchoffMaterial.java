 ...
 *
 */
public class OrthotropicStVenantKirchoffMaterial extends FemMaterial {

   public static PropertyList myProps =
      new PropertyList (OrthotropicStVenantKirchoffMaterial.class, FemMaterial.class);
   ...
   public OrthotropicStVenantKirchoffMaterial (){
      myB = new SymmetricMatrix3d();
      myB2 = new SymmetricMatrix3d();
   }

   public OrthotropicStVenantKirchoffMaterial (double E, double nu) {
      this();
      setYoungsModulus (E);
      setPoissonsRatio (nu);
   }
   ...
   public void computeStress (
      ...
      myB2.mulTransposeLeft (myB); // myB2 = B^T*B
   ...
   public boolean equals (FemMaterial mat) {
      if (!(mat instanceof OrthotropicStVenantKirchoffMaterial)) {
         return false;
      }
      OrthotropicStVenantKirchoffMaterial stvk = (OrthotropicStVenantKirchoffMaterial)mat;
      if (myNu != stvk.myNu ||
          myE != stvk.myE) {
         return false;
      }
   ...
   public OrthotropicStVenantKirchoffMaterial clone() {
      OrthotropicStVenantKirchoffMaterial mat = (OrthotropicStVenantKirchoffMaterial)super.clone();
   ...
   public static void main (String[] args) {
      OrthotropicStVenantKirchoffMaterial mat = new OrthotropicStVenantKirchoffMaterial();
