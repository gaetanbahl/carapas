...
/**
 * Dynamic double array (saves on memory vs {@link ArrayList})
 * @author Antonio
 *
 */
public class DynamicDoubleArray extends ModifiedVersionBase implements Cloneable {
   ...
   public DynamicDoubleArray(double... vals) {
    ...
    */
   public DynamicDoubleArray slice(int start, int size) {
      DynamicDoubleArray out = new DynamicDoubleArray (size);
   ...
   public DynamicDoubleArray clone ()  {
      ...
      DynamicDoubleArray out;
      try {
         out = (DynamicDoubleArray)(super.clone ());
      }
