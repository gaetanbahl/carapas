...
\subsection{rendering signed distance grids and surfaces}

render distance surface

However, in general, you typically *do* want to make sure that the
mesh is centered on the centroid (or center of volume), and sometimes
aligned with the OBB as well.

To facilitate that, I've added the methods

   translateToCentroid()
   transformToOBB()
   transformToOBB(method)
   getOBB()
   getOBB(method)

to MeshBase, as well as
...
\href{\artisynthDocBase/html/modelguide/modelguide.html}{ArtiSynth
Modeling Guide} and, for the GUI aspects, the
...
\href{\artisynthDocBase/html/modelguide/modelguide.html}%
...
3.5 (``Meshes'') of the \href{\artisynthDocBase/html/modelguide/modelguide.html}{ArtiSynth
...
\href{\artisynthDocBase/html/modelguide/modelguide.html}{ArtiSynth Modeling Guide}.
...
\href{\artisynthDocBase/html/documentation/documentation.html}{Writing Documentation for ArtiSynth}.
...
\href{\artisynthDocBase/html/matlabAndJython/matlabAndJython.html}%
...
The \href{\artisynthDocBase/html/artisynth/artisynth.html}%
...
\href{\artisynthDocBase/html/maspack/maspack.html#S3.SS3}%
{Object Selection}
...
\href{\artisynthDocBase/html/installation/installation.html}%
{Installation Guide}.
...
\href{\artisynthDocBase/html/documentation/documentation.html}%
...
\href{\artisynthDocBase/html/artisynth/artisynth.html}{ArtiSynth
Reference Manual}.
...
\href{\artisynthDocBase/html/artisynth/artisynth.html#AdaptiveStepping}%
{reference manual}.
...
given in the
\href{\artisynthDocBase/html/artisynth/artisynth.html#ModelAgentState}%
{reference manual}.
...
\href{\artisynthDocBase/html/documentation/documentation.html#Installing}{documentation} document.
