...
\javaclass[artisynth.core.modelbase]{ModelComponent}, which contains a
...
\javamethod[artisynth.core.modelbase.ModelComponent]{getParent()} 
returns the component's parent, which is a 
\javaclass[artisynth.core.modelbase]{CompositeComponent} (Section
...
\javamethod[artisynth.core.modelbase.ModelComponent]{notifyParentOfChange()},
which propagates an appropriate change event up the hierarchy. It will
typically do this by calling the
\javamethod[artisynth.core.modelbase.CompositeComponent]{componentChanged()}
method of the parent (see Section \ref{CompositeComponentSec}).

The method
\javamethod[artisynth.core.modelbase.ModelComponent]{hasState()}
...
\javaclass[artisynth.core.modelbase]{StructureChangeEvent} for which
\javamethod[artisynth.core.modelbase.StructureChangeEvent]{stateIsChanged()}
returns {\tt true}.
...
selected, its
\javamethod[artisynth.core.modelbase.ModelComponent]{isSelected()}
...
\begin{sideblock}
{\bf Important:}\\
\javamethod[artisynth.core.modelbase.ModelComponent]{setSelected()}
...
For convenience,
\javaclass[artisynth.core.modelbase]{ModelComponentBase} provides a
...
\javamethod[artisynth.core.modelbase]{ComponentUtils.isConnected()} 
...
\javaclass[artisynth.core.modelbase]{CompositeComponent} is a
subinterface of \javaclass[artisynth.core.modelbase]{ModelComponent}
...
\javaclass[artisynth.core.modelbase]{MutableCompositeComponent} is a
subinterface of
\javaclass[artisynth.core.modelbase]{CompositeComponent} which allows
...
\javaclass[artisynth.core.modelbase]{CompositeComponent} is provided
by \javaclass[artisynth.core.modelbase]{CompositeComponentBase}. It is
...
\javaclass[artisynth.core.modelbase]{ComponentList} is a much more
flexible class which implements
\javaclass[artisynth.core.modelbase]{MutableCompositeComponent} and
...
\javaclass[artisynth.core.modelbase]{MutableCompositeComponent} (which
...
either by calling
\javamethod[artisynth.core.modelbase.ModelComponent]{setFixed()}, or
by adding the component using the
\javamethod[artisynth.core.modelbase.ComponentList]{addFixed()} method
of {\tt ComponentList}.
\end{sideblock}

The class \javaclass[artisynth.core.modelbase]{ComponentListImpl} is
available as an internal implementation class for constructing
instances of either
\javaclass[artisynth.core.modelbase]{CompositeComponent} or
\javaclass[artisynth.core.modelbase]{MutableCompositeComponent}.  It
...
\javaclass[artisynth.core.modelbase]{CompositeComponentBase} or
...
A \javaclass[artisynth.core.modelbase]{Model} is a specific
\javaclass[artisynth.core.modelbase]{ModelComponent} that can contain
...
\javaclass[artisynth.core.modelbase]{StepAdjustment} object to request
...
\javaclass[artisynth.core.modelbase]{StepAdjustment} object, which
...
\javamethod[artisynth.core.modelbase.ComponentListImpl]%
...
\javamethod[artisynth.core.modelbase]{ScanWriteUtils.scanAndStorePropertyValues()}
and 
