...
public class LinearVsLinearish extends RootModel {
   ...
   public void build(String[] args) throws IOException {
      ...
      FemModel3d femLinearish = createFem("Linearish");
      femLinearish.setMaterial(new LinearishMaterial(E, nu, true));
      RenderProps.setFaceColor(femLinearish, Color.RED);
      RenderProps.setAlpha(femLinearish, 0.8);
      mech.addModel(femLinearish);
      femLinearish.useNewStressAndStiffness = true;
